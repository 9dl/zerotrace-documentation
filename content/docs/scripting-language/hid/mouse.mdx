...
<Callout type="info">
    - Windows: Ignores absolute values, only processes relative.
    - Linux/macOS: Supports absolute values for mice.
    - ^ Note: Absolute mouse commands may not work on all systems, especially Windows. It's recommended to use relative commands for better compatibility.
</Callout>
