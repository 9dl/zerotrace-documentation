...
<Tabs items={["setDelay", "defaultdelay", "altcode", "jamKeys"]}>
    <Tab value="setDelay">
    ...
    <Tab value="altcode">
        **Description:** Sends ALT code sequences or strings.

        **Syntax:**
        ```plaintext
        altcode 'code' '<number>'  // For numeric ALT codes
        altcode '<string>'       // For string input
        ```

        **Example:**
        ```plaintext
        altcode 'code 234'  // Types Û
        altcode '™'         // Types trademark symbol
        ```
    </Tab>
